    ...
    <ContentTemplate>
     ...
     <label class="label-1">Email Address*</label>
            ...
            <div class="form_line_btn">
                <asp:ImageButton ID="imgBtn" runat="server" ImageUrl="/content/images/tryitnow_btn.png" OnClick="imgBtn_OnClick" />
               
            </div>
            <div class="form_line_guarantee">
                <a href="#guarantee" class="guarantee">30-Day Money-Back Guarantee!</a></div>
            <div class="form_line_guarantee"><img src="/Content/Images/norton_form.jpg" /></div>
        </div>
